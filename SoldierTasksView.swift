...
struct SoldierTasksView: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(colors: [Color.black, Color(.sRGB, red: 0.05, green: 0.15, blue: 0.10, opacity: 1)],
